...
pub struct TokenPair {
    ...
    /// Raw (unhashed) refresh token — send to client once, never store raw
...
/// Generates a cryptographically random 64-char alphanumeric refresh token.
...
/// Returns the expiry datetime string for a new refresh token.
